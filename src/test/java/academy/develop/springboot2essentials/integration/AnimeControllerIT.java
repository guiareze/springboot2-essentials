package academy.develop.springboot2essentials.integration;
...
import academy.develop.springboot2essentials.wrapper.PageableResponse;
...
public class AnimeControllerIT {
    ...
    void findByName_ReturnsEmptyListOfAnime_WhenAnimeIsNotFound(){
        List<Anime> anime = testRestTemplate.exchange("/animes/find?name=dbz", HttpMethod.GET, null,
                new ParameterizedTypeReference<List<Anime>>() {
                }).getBody();
        Assertions.assertThat(anime)
                .isNotNull()
